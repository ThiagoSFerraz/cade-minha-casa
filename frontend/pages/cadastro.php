...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarmenu" style="width:25%;">
                    <div class="mb-1 me-3">
                        <a href="./login.php"><button type="button" class="btn border border-warning rounded-pill" style="width:100%;">Login</button></a>
                    </div>
                    <div class="mb-1 me-3">
    ...
    <div class="container-fluid" style="background-image: url(../images/fundo.png); background-repeat: no-repeat; height: 100%;">
        <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8 col-sm-12 mb-md-3 mb-sm-3 mt-lg-5 mt-md-3 mt-sm-2">
                <h1 class="display-3 text-white fw-bolder">Cadastre-se!</h1>
            </div>
        </div>
            ...
            <div class="col-lg-5 col-sm-12 card rounded mt-lg-5 mt-md-3 mt-sm-4 mb-5">
                <div class="card-body">
                    ...
                    <form action="../../backend/cadastro_user.php" method="POST">
                        <h5 class="card-title text-center mb-md-5 mt-md-5 mb-sm-3 mt-sm-4">Formulário de Cadastro</h5>
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-10 mb-3">
                                <form action="" method="POST">
                                    <label for="inputNome" class="form-label">Digite seu nome:</label>
                                    <input type="nome" name="nome" class="form-control rounded-pill text-muted" id="InputNome" aria-describedby="nome" placeholder="Nome">
                            ...
                            <div class="col-10 mb-3">
                                ...
                                <input type="email" name="email" class="form-control rounded-pill bg-white" id="InputEmail" placeholder="Seu email">
                            ...
                            <div class="col-10 mb-3">
                                ...
                                <input type="password" name="senha" class="form-control rounded-pill bg-white" id="InputPassword" placeholder="Senha">
                            ...
                            <div class="col-10 mb-3">
                                ...
                                <label for="inputConfirmarSenha" class="form-label">Confirme sua senha:</label>
                                <input type="password" name="conf_senha" class="form-control rounded-pill bg-white" id="confirmePassword" placeholder="Confirme sua senha">
